...
HD_PWD='C:/Users/SIVA DHANUSH REDDY/Downloads/UART_SPI/SPI_Bootloader/Spi_Flashcontroller.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_flash.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_flash.tcl -notrace
