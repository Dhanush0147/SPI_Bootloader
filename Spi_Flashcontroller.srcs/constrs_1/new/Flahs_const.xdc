...
#set_property -dict { PACKAGE_PIN M13   IOSTANDARD LVCMOS33 } [get_ports { miso_spi }]; #IO_L6N_T0_D08_VREF_14 Sch=sw[2]
...
#set_property -dict { PACKAGE_PIN R18   IOSTANDARD LVCMOS33 } [get_ports { mosi_spi }]; #IO_L7P_T1_D09_14 Sch=led[4]
