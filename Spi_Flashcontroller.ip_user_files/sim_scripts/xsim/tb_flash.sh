...
#
# Script generated by Vivado on Fri Jan 16 18:10:52 +0530 2026
# SW Build 5239630 on Fri Nov 08 22:35:27 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : tb_flash.sh
...
#
# Usage        : tb_flash.sh
#                tb_flash.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                tb_flash.sh [-reset_run]
#                tb_flash.sh [-reset_log]
#                tb_flash.sh [-help]
#
...
# script info
echo -e "tb_flash.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./tb_flash.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L xpm -L blk_mem_gen_v8_4_9 -L uvm -L unisims_ver -L unimacro_ver -L secureip --snapshot tb_flash xil_defaultlib.tb_flash xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim tb_flash -key {Behavioral:sim_1:Functional:tb_flash} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb tb_flash.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./tb_flash.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: tb_flash.sh [-help]\n\
Usage: tb_flash.sh [-step]\n\
Usage: tb_flash.sh [-lib_map_path]\n\
Usage: tb_flash.sh [-reset_run]\n\
Usage: tb_flash.sh [-reset_log]\n\
Usage: tb_flash.sh [-keep_index]\n\
Usage: tb_flash.sh [-noclean_files]\n\n\
